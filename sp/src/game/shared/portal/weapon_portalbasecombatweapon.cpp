...
//this code is exactly the same as the code in basehlcombatweapon_shared.cpp so i have no idea what's the point of redefining it separately here
//I'm just gonna use the code from basehlcombatweapon_shared.cpp
//#if defined( CLIENT_DLL )
//
