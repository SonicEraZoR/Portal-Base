...
static ConVar cl_playermodel("cl_playermodel", "models/sirgibs/ragdolls/gordon_survivor_player.mdl", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_SERVER_CAN_EXECUTE, "Default Player Model");
